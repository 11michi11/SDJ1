...
public class Car {
	...
	//service method for servicing in current date
	public void service() {
		this.serviceBook.addService(new Service(this.mileage, new Date()));
	}

	//service method for servicing in specific date
	...
	public boolean equals(Object obj) {
		if (obj instanceof Car) {
			Car other = (Car) obj;
			if (this.mileage == other.mileage && this.registrationNumber.equals(other.registrationNumber)
